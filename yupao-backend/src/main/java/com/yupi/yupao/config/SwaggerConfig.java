...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("一只小小丑用户中心")
                .description("一只小小丑用户中心接口文档")
                .termsOfServiceUrl("https://github.com/onesleepyjoker/friend-backend")
                .contact(new Contact("yupi","https://github.com/onesleepyjoker/friend-backend","xxx@qq.com"))
                .version("1.0")
                .build();
    }
}

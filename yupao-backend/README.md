...
> 作者：[一只小小丑](https://github.com/onesleepyjoker/friend-backend)

本项目为 [一只小小丑](https://github.com/onesleepyjoker/friend-backend) 的原创全栈项目，后端代码开源。

[jokerfan](https://github.com/onesleepyjoker/friend-backend)



## 项目简介

[一只小小丑](https://github.com/onesleepyjoker/friend-backend) 一个帮助大家找到志同道合的伙伴的移动端网站（APP 风格）。包括用户登录注册、更新个人信息、按标签搜索用户、推荐相似用户、组队等功能。
